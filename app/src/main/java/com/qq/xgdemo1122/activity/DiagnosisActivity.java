...
import com.qq.xgdemo1122.bean.ClickAction;
import com.qq.xgdemo1122.bean.Style;
import com.qq.xgdemo1122.bean.TimeInterval;
import com.qq.xgdemo1122.common.CommonWorkingThread;
import com.qq.xgdemo1122.common.ExtendedListView;
import com.qq.xgdemo1122.common.ExtendedListView.OnPositionChangedListener;
import com.qq.xgdemo1122.common.XingeApp;
...
public class DiagnosisActivity extends Activity implements OnPositionChangedListener {
    ...
    private void step3() {
        ...
        String PushServiceName = XGPushServiceV4.class.getName();
    ...
    private void step4() {
        ...
        local_msg.setMin("10");
        local_msg.setActivity("SettingActivity");
    ...
    private void step7() {
        ...
        int ret_code = 0;
        try {
            com.qq.xgdemo1122.bean.Message message = new com.qq.xgdemo1122.bean.Message();
            message.setType(com.qq.xgdemo1122.bean.Message.TYPE_NOTIFICATION);
