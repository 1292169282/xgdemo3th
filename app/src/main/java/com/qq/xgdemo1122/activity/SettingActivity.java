...
public class SettingActivity extends Activity {
    ...
    public void initNotificationBuilder(Context context) {
        ...
        build.setIcon(R.drawable.testnotification)
                .setSound(
    ...
    private void initLocalMessage() {
        ...
        // 设置消息日期，格式为：20140502
        local_msg.setDate("20180912");

        // 设置消息触发的小时(24小时制)，例如：22代表晚上10点
        local_msg.setHour("16");
        ...
        // 设置动作类型：1打开activity或app本身，2打开浏览器，3打开Intent
